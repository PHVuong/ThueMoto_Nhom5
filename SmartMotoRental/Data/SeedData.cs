    ...
    public static async Task SeedAsync(SmartMotoRentalContext context)
    {
        ...
        if (!await context.Motorbikes.AnyAsync())
        {
            var motorbikes = new List<Motorbike>
            {
                new Motorbike
                {
                    ...
                    Description = "Xe mới 100%, động cơ êm ái, tiết kiệm nhiên liệu.",
                ...
                new Motorbike
                {
                    ...
                    PricePerDay = 135000,
                    Location = "Thanh Khê, Đà Nẵng",
                    Description = "Xe số thể thao, động cơ mạnh mẽ.",
                ...
                new Motorbike
                {
                    ...
                    PricePerDay = 140000,
                    Location = "Hải Châu, Đà Nẵng",
                    Description = "Xe tay ga thân thiện với môi trường.",
        ...
        if (!await context.Notifications.AnyAsync())
        {
            context.Notifications.AddRange(
                new Notification { Message = "Xe A đã được đặt thành công" },
                new Notification { Message = "Lịch thuê xe của bạn sắp đến hạn" },
                new Notification { Message = "Xe B có ưu đãi 20%" }
            );
